...
public class BattleShipGame {
    ...
    public void generateAppShot() {
        ...
        } while (isAvailableShot(appShots, randomShot) == false);
        appShots.add(randomShot);
        if (impactEnemyShip(playerShips, randomShot)) {
            playerFleetBoard.setShipOnBoard(randomShot);
        } else {
    ...
    private Position getRandomPosition() {
        ...
        Integer row = random.nextInt(10);
        Integer column = random.nextInt(10);
